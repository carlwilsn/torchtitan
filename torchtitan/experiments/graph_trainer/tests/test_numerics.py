...
DSV3_EP_OVERLAP_OPTIONS = (
    ...
    " --compile.ep_overlap_chunk_dim batch"
    " --compile.ep_overlap_module_fqn layers.*"
)
DSV3_EP_OVERLAP_MOE_SEQ_OPTIONS = (
    "--compile.mode aot_fx_trace"
    " --compile.passes ep_overlap"
    " --compile.ep_overlap_chunk_dim seq"
...
DSV3_EP_OVERLAP_EAGER = " --compile.ep_overlap_chunk_strategy eager"
DSV3_EP_OVERLAP_GRAPH = " --compile.ep_overlap_chunk_strategy graph"
DSV3_EP_OVERLAP_GRAPH_BITWISE = (
    DSV3_EP_OVERLAP_GRAPH + " --compile.ep_overlap_disable_early_grad_accumulation"
)
...
def _run_deepseek_v3_loss_compare(
    ...
    *,
    baseline_config: str = "deepseek_v3_debugmodel_ep_ce_loss",
    test_config: str = "graph_trainer_deepseek_v3_debugmodel_ep",
...
def _run_deepseek_v3_ep_overlap_loss_compare() -> bool:
    ...
    return _run_deepseek_v3_loss_compare(
        baseline_config="graph_trainer_deepseek_v3_debugmodel_ep",
