    ...
    def forward(
        ...
        if self.use_rope:
            if self.rope_backend == "cos_sin":
                xq_BLNH, xk_BLNH = apply_rotary_emb_cos_sin(
                    xq_BLNH, xk_BLNH, rope_cache, positions
                )
            else:
                xq_BLNH, xk_BLNH = apply_rotary_emb_complex(
                    xq_BLNH, xk_BLNH, freqs_cis=rope_cache, positions=positions
                )
